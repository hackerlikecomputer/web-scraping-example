...
project_folder = '/home/hackerlikecomputer/proj/CPD-Adult-Arrests-Scraper'
...
def scrape_detail_pages(d):
    for dataset in tqdm(d, position=0, desc='DATASETS'):
        beat = str(dataset[0])
...
#first scrape the results 
datasets = scrape_results_pages() 
#then scrape detail pages 
try: 
